...
// DevUsecase is an autogenerated mock type for the DevUsecase type
type DevUsecase struct {
	mock.Mock
}

// AddValueToSSTFile provides a mock function with given fields: ctx, fileName, key, value
func (_m *DevUsecase) AddValueToSSTFile(ctx context.Context, fileName string, key string, value []byte) ([]byte, error) {
...
func (_m *DevUsecase) ListDB(ctx context.Context) []domain.DB {
	ret := _m.Called(ctx)
...
func (_m *DevUsecase) PullFile(ctx context.Context, fileName string, source string, ingestFolder string) error {
...
// NewDevUsecase creates a new instance of DevUsecase. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
// The first argument is typically a *testing.T value.
func NewDevUsecase(t interface {
	mock.TestingT
	Cleanup(func())
}) *DevUsecase {
	mock := &DevUsecase{}

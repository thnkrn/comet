...
func (_m *AdminRepository) CatchUpWithPrimary(ctx context.Context, dbName string) error {
...
func (_m *AdminRepository) CreateCheckPoint(ctx context.Context, dbName string, dir string) error {
...
func (_m *AdminRepository) GetDBProperty(ctx context.Context, dbName string, property string) (string, error) {
...
func (_m *AdminRepository) GetLastIngest(ctx context.Context, dbName string) ([]byte, error) {
	ret := _m.Called(ctx, dbName)
...
// Ingest provides a mock function with given fields: ctx, dbName, dir, filesPath
func (_m *AdminRepository) Ingest(ctx context.Context, dbName string, dir string, filesPath []string) error {
	ret := _m.Called(ctx, dbName, dir, filesPath)

	var r0 error
	if rf, ok := ret.Get(0).(func(context.Context, string, string, []string) error); ok {
		r0 = rf(ctx, dbName, dir, filesPath)
	} else {
		r0 = ret.Error(0)
	}
